...
if __name__ == "__main__":
    ...
    while(not rospy.is_shutdown()):
        ...
        time_scale = 0.05
        pos_scale = 5.0
        pose.pose.position.x = pos_scale*math.sin(time_scale*2*math.pi*rospy.Time.now().to_sec())
        pose.pose.position.y = pos_scale*math.cos(time_scale*2*math.pi*rospy.Time.now().to_sec())
